...
_Cursiva_ Se usa para archivos, carpetas, rutas de acceso (para elementos largos, divididos en su propia línea), términos nuevos y direcciones URL (a menos que se representen como vínculos, que es el valor predeterminado).
