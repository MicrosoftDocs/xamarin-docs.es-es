...
* Registros de compilación completos, con el máximo nivel `-v -v -v -v` de detalle (por ejemplo, en los **argumentos MMP adicionales**);
...
#### <a name="mm0001-this-version-of-xamarinmac-requires-mono-0-the-current-mono-version-is-1-please-update-the-monoframework-from-httpmono-projectcomdownloads"></a>MM0001: Esta versión de Xamarin. Mac requiere mono {0} (la versión de mono actual {1}es). Actualice mono. Framework desde http://mono-project.com/Downloads

<a name="MM0003" />

#### <a name="mm0003-application-name-0exe-conflicts-with-an-sdk-or-product-assembly-dll-name"></a>MM0003: El nombre de{0}aplicación ". exe" entra en conflicto con un nombre de ensamblado de SDK o de producto (. dll).
...
#### <a name="mm0008-you-should-provide-one-root-assembly-only-found-0-assemblies-1"></a>MM0008: Solo debe proporcionar un ensamblado raíz, los {0} ensamblados encontrados{1}: ' '
...
#### <a name="mm0023-application-name-0exe-conflicts-with-another-user-assembly"></a>MM0023: El nombre de{0}aplicación ". exe" entra en conflicto con otro ensamblado de usuario.

<a name="MM0026" />

#### <a name="mm0026-could-not-parse-the-command-line-argument-0-1"></a>MM0026: No se pudo analizar el argumento de línea{0}de comandos ' ':{1}

<a name="MM0043" />

#### <a name="mm0043-the-boehm-garbage-collector-is-not-supported-the-sgen-garbage-collector-has-been-selected-instead"></a>MM0043: No se admite el recolector de elementos no utilizados de Boehm. En su lugar, se ha seleccionado el recolector de elementos no utilizados de SGen.
...
#### <a name="mm0059-could-not-find-the-currently-selected-xcode-on-the-system-0"></a>MM0059: No se pudo encontrar la Xcode seleccionada actualmente en el sistema {0}:;
...
#### <a name="mm0068-invalid-value-for-target-framework-0"></a>MM0068: Valor no válido para la versión {0}de .NET Framework de destino:.
...
#### <a name="mm0079-internal-error---no-executable-was-copied-into-the-app-bundle-please-contact-supportxamarincom"></a>MM0079: Error interno: no se ha copiado ningún ejecutable en el lote de aplicaciones. Póngase en contactosupport@xamarin.comcon ' '

<a name="MM0080" />

#### <a name="mm0080-disabling-newrefcount---new-refcountfalse-is-deprecated"></a>MM0080: La deshabilitación de NewRefCount,--New-refcount: false, está en desuso.
...
#### <a name="mm0097-machineconfig-file-0-can-not-be-found"></a>MM0097: no se puede encontrar el{0}archivo Machine. config ' '.
...
#### <a name="mm0099-internal-error-0-please-file-a-bug-report-with-a-test-case-httpbugzillaxamarincom"></a>MM0099: Error {0}interno. Registre un informe de errores con un caso de prueba http://bugzilla.xamarin.com) (.
...
#### <a name="mm0129-debugging-symbol-file-for--does-not-match-the-assembly-and-is-ignored"></a>MM0129: El archivo de símbolos de depuración de ' * ' no coincide con el ensamblado y se omite.
...
#### <a name="mm0130-no-root-assemblies-found-you-should-provide-at-least-one-root-assembly"></a>MM0130: No se encontró ningún ensamblado raíz. Debe proporcionar al menos un ensamblado raíz.

Al ejecutar `--runregistrar`, se debe proporcionar al menos un ensamblado raíz.

<a name="MM0131" />

#### <a name="mm0131-product-assembly-0-not-found-in-assembly-list-1"></a>MM0131: No se encuentra{0}el ensamblado del producto ' ' en{1}la lista de ensamblados: ' '
...
#### <a name="mm0133-found-more-than-1-assembly-matching-0-choosing-first-1"></a>MM0133: Se encontró más de un ensamblado{0}que coincida con ' '{1}eligiendo primero: ' '
...
#### <a name="mm0135-did-not-link-system-framework-0-referenced-by-assembly-1-because-it-was-introduced-in-2-3-and-were-using-the-2-4-sdk"></a>MM0135: No se ha vinculado el{0}marco de trabajo del sistema ' '{1}(al que hace referencia el ensamblado ' ') porque se {2} presentó en {2} {3}y estamos usando el {4} SDK.
...
#### <a name="mm1403-0-1-could-not-be-found-target-framework-0-is-unusable-to-package-the-application"></a>No se {0} encontró{1}MM1403: ' '. La versión de{0}.NET Framework de destino ' ' no se puede usar para empaquetar la aplicación.

<a name="MM1404" />

#### <a name="mm1404-target-framework-0-is-invalid"></a>MM1404: La plataforma de{0}destino ' ' no es válida.

<a name="MM1405" />

#### <a name="mm1405-usefullxammacframework-must-always-target-framework-net-45-not-0-which-is-invalid"></a>MM1405: useFullXamMacFramework siempre debe tener como destino .NET Framework 4,5,{0}no ' ', que no es válido

<a name="MM1406" />

#### <a name="mm1406-target-framework-0-is-invalid-when-targetting-xamarinmac-45-net-framwork"></a>MM1406: La plataforma de{0}destino ' ' no es válida cuando destino Xamarin. Mac 4,5 .NET Framework.

<a name="MM1407" />

#### <a name="mm1407-mismatch-between-xamarinmac-reference-0-and-target-framework-selected-1"></a>MM1407: No coinciden las referencias de Xamarin{0}. Mac ' ' y la{1}versión de .NET Framework de destino seleccionada ' '.
...
#### <a name="mm1600-not-a-mach-o-dynamic-library-unknown-header-0x0-1"></a>MM1600: No es una biblioteca dinámica de Mach-O (encabezado desconocido{0}' 0x ' {1}):.
...
#### <a name="mm1602-not-a-mach-o-dynamic-library-unknown-header-0x0-1"></a>MM1602: No es una biblioteca dinámica de Mach-O (encabezado desconocido{0}' 0x ' {1}):.

<a name="MM1603" />

#### <a name="mm1603-unknown-format-for-fat-entry-at-position-0-in-1"></a>MM1603: Formato desconocido para la entrada FAT en {0} la {1}posición en.

<a name="MM1604" />

#### <a name="mm1604-file-of-type-0-is-not-a-macho-file-1"></a>MM1604: El archivo de {0} tipo no es un archivo MachO{1}().
...
#### <a name="mm2004-extra-linker-definitions-file-0-could-not-be-located"></a>MM2004: No se encontró el archivo de{0}definiciones del vinculador adicional ' '.

<a name="MM2005" />

#### <a name="mm2005-definitions-from-0-could-not-be-parsed"></a>MM2005: No se pudieron{0}analizar las definiciones de ' '.

<a name="MM2006" />

#### <a name="mm2006-native-library-0-was-referenced-but-could-not-be-found"></a>MM2006: Se hizo referencia{0}a la biblioteca nativa ' ', pero no se pudo encontrar.

<a name="MM2007" />

#### <a name="mm2007-xamarinmac-unified-api-against-a-full-net-profile-does-not-support-linking-pass-the--nolink-flag"></a>MM2007: Los Unified API de Xamarin. Mac en un perfil de .NET completo no admiten la vinculación. Pase la marca-nolink.

<a name="MM2009" />

#### <a name="mm2009-referenced-by-01------this-message-is-related-to-mm2006-"></a>MM2009: Al que hace referencia{1} {0}.     * * Este mensaje está relacionado con MM2006 * *

<a name="MM2010" />

#### <a name="mm2010-unknown-httpmessagehandler-0-valid-values-are-httpclienthandler-default-cfnetworkhandler-or-nsurlsessionhandler"></a>MM2010: HttpMessageHandler `{0}`desconocido. Los valores válidos son HttpClientHandler (predeterminado), CFNetworkHandler o NSUrlSessionHandler
...
#### <a name="mm2012-only-first-0-of-1-referenced-by-warnings-shown--this-message-related-to-2009-"></a>MM2012: Solo se {0} muestra {1} la primera de las advertencias "a las que se hace referencia". ** Este mensaje relacionado con 2009 \*\*

<a name="MM2013" />

#### <a name="mm2013-failed-to-resolve-the-reference-to-0-referenced-in-1-the-app-will-not-include-the-referenced-assembly-and-may-fail-at-runtime"></a>MM2013: No se pudo resolver la referencia a{0}"", a la que{1}se hace referencia en "". La aplicación no incluirá el ensamblado al que se hace referencia y puede producir un error en tiempo de ejecución.

<a name="MM2014" />

#### <a name="mm2014-xamarinmac-extensions-do-not-support-linking-request-for-linking-will-be-ignored--this-message-is-obsolete-in-xm-36-"></a>MM2014: Las extensiones de Xamarin. Mac no admiten la vinculación. Se omitirá la solicitud de vinculación. ** Este mensaje es obsoleta en XM 3.6 + \*\*

<!-- 2015 used by mtouch -->

<a name="MM2016" />

#### <a name="mm2016-invalid-tlsprovider-0-option-the-only-valid-value-1-will-be-used"></a>MM2016: Opción TlsProvider `{0}` no válida. Se usará el único `{1}` valor válido.
...
#### <a name="mm2100-xamarinmac-classic-api-does-not-support-platform-linking"></a>MM2100: Xamarin. Mac Classic API no admite la vinculación de plataformas.
...
El mensaje apuntará al método que llama `BlockLiteral.SetupBlock[Unsafe]`a y también puede proporcionar pistas sobre el motivo por el que no se pudo optimizar la llamada.
...
Para quitar la advertencia, quite el argumento de optimización de MMP o pase `--nowarn:2107` para omitirlo.

De forma predeterminada, esta opción se habilitará automáticamente siempre que sea posible y segura.

<a name="MM2108" />

#### <a name="mm2108-0-was-stripped-of-architectures-except-1-to-comply-with-app-store-restrictions-this-could-break-exisiting-codesigning-signatures-consider-stripping-the-library-with-lipo-or-disabling-with---optimize-trim-architectures"></a>MM2108: '{0}' se ha quitado de las arquitecturas{1}excepto ' ' para cumplir con las restricciones de App Store. Esto podría interrumpir las firmas de codiseño existentes. Considere la posibilidad de quitar la biblioteca con Lipo o deshabilitarla con--Optimize =-Trim-Architectures ");
...
Considere la `lipo` posibilidad de usar para quitar las arquitecturas innecesarias de la biblioteca de origen de forma permanente. Si la aplicación no se publica en la tienda de aplicaciones, esta eliminación se puede deshabilitar pasando `--optimize=-trim-architectures` como argumentos MMP adicionales.

<a name="MM2109"/>

#### <a name="mm2109-xamarinmac-classic-api-does-not-support-platform-linking"></a>MM2109: Xamarin. Mac Classic API no admite la vinculación de plataformas.
...
#### <a name="mm3001-could-not-aot-the-assembly-0"></a>MM3001: No se pudo el ensamblado{0}"" en AOT
...
#### <a name="mm3009-aot-of-0-was-requested-but-was-not-found"></a>MM3009: Se solicitó{0}AOT de ' ', pero no se encontró

<a name="MM3010" />

#### <a name="mm3010-exclusion-of-aot-of-0-was-requested-but-was-not-found"></a>MM3010: Se solicitó la exclusión{0}del AOT de ' ', pero no se encontró
...
1. El tipo del delegado administrado es `System.Delegate` o. `System.MulticastDelegate` Estos tipos no representan una firma específica, lo que significa que el registrador no puede calcular la firma nativa correspondiente. En este caso, la solución consiste en usar un tipo de delegado específico para el bloque (alternativamente, se puede omitir `--nowarn:4173` la advertencia agregando como argumento MMP adicional en las opciones de compilación de Mac del proyecto).
2. El registrador no puede `Invoke` encontrar el método del delegado. Esto no sucede, por lo que debe archivar un [problema](https://github.com/xamarin/xamarin-macios/issues/new) con un proyecto de prueba para poder corregirlo.

<a name="MT4174" />

#### <a name="mt4174-unable-to-locate-the-block-to-delegate-conversion-method-for-the-method-methods-parameter-parameter"></a>MT4174: No se puede encontrar el método de conversión de bloque al delegado para el parámetro {Method} del método {{Parameter}.
...
#### <a name="mm5101-missing-0-compiler-please-install-xcode-command-line-tools-component"></a>MM5101: Falta el{0}compilador ' '. Instale el componente de las herramientas de línea de comandos de Xcode.
...
#### <a name="mm5202-monoframework-mdk-is-missing-please-install-the-mdk-for-your-monoframework-version-from-httpmono-projectcomdownloads"></a>MM5202: Falta mono. Framework MDK. Instale MDK para la versión de mono. Framework desde http://mono-project.com/Downloads
...
#### <a name="mm5306-missing-dependencies-please-install-xcode-command-line-tools-component"></a>MM5306: Faltan dependencias. Instale el componente de las herramientas de línea de comandos de Xcode.

<a name="MM5308" />

#### <a name="mm5308-xcode-license-agreement-may-not-have-been-accepted--please-launch-xcode"></a>MM5308: Es posible que no se haya aceptado el contrato de licencia de Xcode.  Inicie Xcode.
...
#### <a name="mm5310-install_name_tool-failed-with-an-error-code-0-check-build-log-for-details"></a>Error de MM5310: install_name_tool con un código de{0}error ' '. Busque detalles en el registro de compilación.

<a name="MM5311" />

#### <a name="mm5311-lipo-failed-with-an-error-code-0-check-build-log-for-details"></a>Error de MM5311: lipo con un código de{0}error ' '. Busque detalles en el registro de compilación.
...
#### <a name="mm8017-the-boehm-garbage-collector-is-not-supported-please-use-sgen-instead"></a>MM8017: No se admite el recolector de elementos no utilizados de Boehm. En su lugar, use SGen.
...
Una posible solución alternativa sería deshabilitar la `register-protocols` optimización, pasando `--optimize:-register-protocols` como argumento MMP adicional en las opciones de compilación de Mac del proyecto.
