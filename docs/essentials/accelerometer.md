...
description: La clase Accelerometer de Xamarin.Essentials permite supervisar el sensor del acelerómetro del dispositivo, que indica la aceleración del dispositivo en un espacio tridimensional.
