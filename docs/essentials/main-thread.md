---
title: "Xamarin.Essentials: MainThread" description: "La clase MainThread permite que las aplicaciones ejecuten código en el subproceso de ejecución principal."
