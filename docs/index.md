...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Configuración e instalación</h3>
                                    <p>Obtenga información sobre cómo instalar Visual Studio Tools para Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Muestras</h3>
                                    <p>Ejemplos de características y aplicaciones preintegradas.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3 class="x-hidden-focus">Novedades</h3>
                                    <p>Vea cuáles son las novedades de la documentación de Xamarin.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="screenReader">Documentación de Xamarin</h1>
        <ul class="pivots">
            <li>
                <li>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="~/xamarin-forms/data-cloud/index.yml"><img  src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt="" />Azure con Xamarin</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Inicio rápido</h3>
                                                <h4>Siga estas guías para compilar su primera aplicación multiplataforma de iOS y Android con Xamarin.Forms, con una dedicación de 5 minutos cada vez.</h4>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Tutoriales</h3>
                                                <h4>Obtenga información sobre conceptos de aplicaciones multiplataforma de iOS y Android, con Xamarin.Forms.</h4>
                                                <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td style="border-top-color:transparent!important;padding-left:0;">
                                                            <ul class="noBullet">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Principios de la aplicación</h3>
                                                    <p>Todo lo que necesita saber para desarrollar aplicaciones de Xamarin.Forms, como navegación, gestos, enlace de datos, etc.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Obtenga información acerca de los controles de interfaz de usuario disponibles en las plataformas compatibles.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>XAML</h3>
                                                    <p>Exprese interfaces de usuario multiplataforma mediante declaración con XAML.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Trabajo con características específicas de la plataforma en Android, iOS y Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>API multiplataforma para tareas habituales relativas a la aplicación.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Datos y Azure Cloud Services</h3>
                                                    <p>Almacenamiento de datos y acceso a Azure Cloud Services.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Implementación y pruebas</h3>
                                                    <p>Instrucciones para crear e implementar aplicaciones, así como sugerencias para probarlas por adelantado.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Conceptos avanzados y funcionamiento interno</h3>
                                                    <p>Funcionamiento de Xamarin.Forms.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Aplicaciones de ejemplo</h3>
                                                    <p>Complete las demostraciones de código y aplicaciones para Xamarin.Forms, que se ejecutan en Windows, iOS y Android.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Libro electrónico de gráficos de SkiaSharp</h3>
                                                    <p>Gráficos vectoriales y animación multiplataforma con SkiaSharp.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Libro sobre aplicaciones móviles</h3>
                                                    <p>Conozca Xamarin.Forms paso a paso con este libro y ejemplos.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Libro electrónico de empresa</h3>
                                                    <p>Guía de arquitectura para desarrollar aplicaciones de empresa de Xamarin.Forms adaptables, fáciles de mantener y que se pueden probar.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Obtenga más información sobre el desarrollo con Visual Studio 2019.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Obtenga más información sobre el desarrollo de .NET en macOS con Visual Studio para Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Interactúe con el simulador de iOS mediante Visual Studio en Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Generador de perfiles de Xamarin</h3>
                                                    <p>Identifique y solucione problemas de rendimiento.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Inserción de .NET</h3>
                                                    <p>Permite que el código existente de .NET se utilice en otros lenguajes de programación.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Incorporación de proyectos Xamarin en una canalización de compilación e integración continuas.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UrhoSharp</h3>
                                                    <p>Juegos y gráficos 3D multiplataforma.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MonoGame</h3>
                                                    <p>Cree juegos para el escritorio, dispositivos móviles y para la consola con C#.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container centered pageFooter">
        ...
        <ul class="links">
           <li>
            ...
            <li>
                <a href="https://dotnet.microsoft.com/platform/community">Comunidad de desarrolladores</a>
            </li>
        </ul>
    </div>
</div>
