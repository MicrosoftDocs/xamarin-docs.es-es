...
- Shell
  ...
  - [Visibilidad de FlyoutItem](~/xamarin-forms/app-fundamentals/shell/flyout.md#flyoutitem-visibility)
...
Xamarin Community Toolkit 1.0 se publicó en enero e incluye el siguiente contenido nuevo:

- [Introducción](/xamarin/community-toolkit/)
- [Introducción](/xamarin/community-toolkit/get-started)
- Comportamientos
...
- [marcado](/xamarin/community-toolkit/markup)
- Vistas
  ...
  - [Escudo](/xamarin/community-toolkit/views/shield)
...
- [Solución de problemas](/xamarin/community-toolkit/troubleshooting)
