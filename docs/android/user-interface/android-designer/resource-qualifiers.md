...
- **Language** &ndash; muestra los recursos de idioma disponibles y ofrece una opción para agregar nuevos recursos de idioma o región.

- El **modo de interfaz de usuario** &ndash; muestra los modos de visualización (como el acoplamiento del **coche** y el acoplamiento del **escritorio**), así como las direcciones de diseño.
...
- Los &ndash; **estándar** constan de un logotipo, un icono y un texto de título con un subtítulo opcional.

- **Lista** &ndash; modo de navegación de lista. En lugar de texto de título estático, este modo presenta un menú de lista para la navegación dentro de la actividad (es decir, se puede presentar al usuario como una lista desplegable).
...
![El tema claro ya está disponible](resource-qualifiers-images/vs/16-light-theme.png "El tema claro ya está disponible")
