...
**Evolucione 2016: todos pueden crear aplicaciones atractivas con el diseño de materiales**
...
- La *cuadrícula de Material* &ndash; una superposición en el superficie de diseño que muestra una cuadrícula, espaciado y líneas para ayudarle a colocar widgets de diseño de acuerdo con las directrices de diseño de materiales.

- El *Editor de temas* &ndash; un pequeño editor de recursos de color que permite establecer información de color para un subconjunto de un tema. Por ejemplo, puede obtener una vista previa de los colores de material, como `colorPrimary`, `colorPrimaryDark`y `colorAccent`.
...
[cuadrícula de diseño de material de![](material-design-features-images/vs/01-material-design-grid-w158-sml.png)](material-design-features-images/vs/01-material-design-grid-w158.png#lightbox)
...
[![la configuración de la cuadrícula, el KEYLINE y el espaciado](material-design-features-images/vs/03-grid-configuration-w158-sml.png)](material-design-features-images/vs/03-grid-configuration-w158.png#lightbox)
...
En el panel izquierdo del editor de **temas** se muestra la lista de colores que componen el tema seleccionado actualmente (en este ejemplo, se usa el `Default Theme`):
...
- El **selector de colores** &ndash; permite cambiar el color seleccionado a cualquier valor arbitrario.

- &ndash; de la **paleta de materiales** permite cambiar el color seleccionado a un valor que se ajuste al diseño del material.

- **Recursos** &ndash; permite cambiar el color seleccionado a uno de los otros recursos de color existentes en el tema.
...
[![pestaña heredar](material-design-features-images/vs/06-inherit-tab-w158-sml.png)](material-design-features-images/vs/06-inherit-tab-w158.png#lightbox)

En este ejemplo, el **tema predeterminado** hereda de un estilo que usa `@color/background_material_light` pero lo reemplaza con `color/material_grey_50`, que tiene un valor de código de color de `#fffafafa`.
...
[Selector de colores de![](material-design-features-images/vs/07-color-picker-w158-sml.png)](material-design-features-images/vs/07-color-picker-w158.png#lightbox)
...
[Recursos de![](material-design-features-images/vs/08-resources-w158-sml.png)](material-design-features-images/vs/08-resources-w158.png#lightbox)
...
Al seleccionar un matiz, el color de la propiedad cambia al matiz seleccionado. En el ejemplo siguiente, se cambia el `Background Tint` del botón a *Indigo 500*:

![Seleccionar Indigo 500](material-design-features-images/vs/10-indigo-w158.png)

`Background Tint` se establece en el código de color para *Indigo 500* (`#ff3f51b5`) y el diseñador actualiza el color de fondo para reflejar este cambio:
...
- *Cuadrícula de diseño de materiales* &ndash; una superposición en el superficie de diseño que muestra una cuadrícula, espaciado y líneas para ayudarle a colocar widgets de diseño de acuerdo con las directrices de diseño de materiales.

- *Paleta de colores de diseño de materiales* &ndash; un cuadro de diálogo del panel de propiedades que le ayuda a elegir un color de la paleta de diseño de material oficial.

- La *escala tipográfica* &ndash; un cuadro de diálogo del panel de propiedades que proporciona una opción de configuración compatible con el diseño de material para la propiedad `textAppearance` de los campos de texto.
...
[cuadrícula de diseño de material de![](material-design-features-images/xs/01-material-design-grid-sml.png)](material-design-features-images/xs/01-material-design-grid.png#lightbox)
...
Cada uno de estos elementos superpuesto es configurable. Al hacer clic en los puntos suspensivos (&hellip;) junto al menú cuadrícula de diseño de materiales, se abre un cuadro de diálogo elemento flotante que le permite deshabilitar o habilitar la cuadrícula, configurar la ubicación de líneas y establecer los espacios. Tenga en cuenta que todos los valores se expresan en `dp` (píxeles independientes de la densidad):

[![la configuración de la cuadrícula, el KEYLINE y el espaciado](material-design-features-images/xs/03-grid-configuration-sml.png)](material-design-features-images/xs/03-grid-configuration.png#lightbox)
...
`Background Tint` se establece en el código de color para *Indigo 500* (`#ff3f51b5`) y el diseñador actualiza el color de fondo del botón para reflejar este cambio:
...
La sección **apariencia del texto** de la pestaña **estilo** del panel de **propiedades** tiene un icono que le permite seleccionar un estilo de `TextAppearance` que se ajusta a la especificación de diseño del material:
...
[![mostrar el estilo 1](material-design-features-images/xs/10-display-1-sml.png)](material-design-features-images/xs/10-display-1.png#lightbox)
...
[![pestaña heredar](material-design-features-images/xs/13-inherit-sml.png)](material-design-features-images/xs/13-inherit.png#lightbox)

En este ejemplo, el **tema predeterminado** hereda de un estilo que usa `@color/background_material_dark` pero lo reemplaza con `color/material_grey_850`, que tiene un valor de código de color de `#ff303030`.
Para obtener más información sobre la herencia de estilos, vea [estilos y temas](https://developer.android.com/guide/topics/ui/themes.html#Inheritance).
...
[Selector de colores de![](material-design-features-images/xs/14-color-picker-sml.png)](material-design-features-images/xs/14-color-picker.png#lightbox)
...
[Recursos de![](material-design-features-images/xs/15-resources-sml.png)](material-design-features-images/xs/15-resources.png#lightbox)
...
[![cambiar el fondo al azul 900](material-design-features-images/xs/17-change-background-to-blue-sml.png)](material-design-features-images/xs/17-change-background-to-blue.png#lightbox)
