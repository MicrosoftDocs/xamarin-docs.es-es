...
- Si usa la versión preliminar 5 de Visual Studio 15.8 o una posterior, puede probar a usar la [distribución OpenJDK Mobile de Microsoft](openjdk.md) (actualmente en versión preliminar) en lugar de JDK 8.
