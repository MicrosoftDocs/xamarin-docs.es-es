...
1. Inicie Visual Studio y cree una aplicación de Xamarin.Forms en blanco llamada **LabelTutorial**.
...
1. Inicie Visual Studio para Mac y cree una aplicación de Xamarin.Forms en blanco llamada **LabelTutorial**.
