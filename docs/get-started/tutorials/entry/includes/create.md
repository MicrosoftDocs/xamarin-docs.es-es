...
1. Inicie Visual Studio y cree una aplicación de Xamarin.Forms en blanco llamada **EntryTutorial**.
...
1. Inicie Visual Studio para Mac y cree una aplicación de Xamarin.Forms en blanco llamada **EntryTutorial**.
