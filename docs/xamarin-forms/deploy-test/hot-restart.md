---
title: "Reinicio rápido de Xamarin" description: "En este documento se describe cómo configurar y usar el reinicio rápido de Xamarin para depurar una aplicación iOS."
