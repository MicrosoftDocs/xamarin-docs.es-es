...
El patrón Maestro y detalle es cuando la vista maestra, normalmente una lista en la parte izquierda, proporciona el contenido que el usuario selecciona para ver detalles sobre ese elemento en la parte derecha.
...
Este patrón es idóneo para el contenido que se presta a un diseño de dos páginas, como un lector de documentos, notas o una mesa de trabajo.
...
El objeto [`CollectionView`](xref:Xamarin.Forms.CollectionView) con un diseño de cuadrícula que se divide en el ancho de la bisagra hace que sea idóneo para ofrecer esta experiencia de doble pantalla.
