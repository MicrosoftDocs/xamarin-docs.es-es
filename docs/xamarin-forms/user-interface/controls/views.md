...
Las vistas son objetos de la interfaz de usuario, como etiquetas, botones y controles deslizantes que normalmente se conocen como *controles* o *widgets* en otros entornos de programación gráficos. Todas las vistas compatibles con Xamarin. Forms derivan de la clase [`View`](xref:Xamarin.Forms.View) . Se pueden dividir en varias categorías:
