...
> [!NOTE]
> También se pueden aplicar decoraciones de texto a [`Span`](xref:Xamarin.Forms.Span) las instancias de. Para obtener más información sobre la `Span` clase, vea [texto con formato](#Formatted_Text).
