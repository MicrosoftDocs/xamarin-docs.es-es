---
title: Polígonos de mapa de Xamarin. Forms, polilíneas y círculos
description: En este artículo se explica cómo crear polígonos, polilíneas y círculos en una instancia de mapa de Xamarin. Forms.
ms.prod: xamarin
