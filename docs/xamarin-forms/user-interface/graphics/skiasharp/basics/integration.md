---
title: "Integration with Xamarin.Forms " Description: "en este artículo se explica cómo crear gráficos de SkiaSharp que respondan a Touch y Xamarin.Forms Elements, y se muestra el código de ejemplo".
