---
title: Imágenes enXamarin.Forms
...
Xamarin.Formsusa la [`Image`](xref:Xamarin.Forms.Image) vista para mostrar las imágenes en una página. Tiene varias propiedades importantes:
