...
| <h3>Editor</h3>Permite escribir y editar varias líneas de texto.<p align="center">![Captura de pantalla de un editor](xaml-controls-images/Editor.png "Label")</p>[API](xref:Xamarin.Forms.Editor)  /  de [Guía](~/xamarin-forms/user-interface/text/editor.md) de | <p valign="center"><pre>&lt;Editor VerticalOptions="FillAndExpand" /&gt;</pre></p> |
|     |     |
