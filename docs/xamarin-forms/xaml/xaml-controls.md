...
| <h3>Elipse</h3>Muestra una elipse o un círculo.<p align="center">![Captura de pantalla de una elipse](xaml-controls-images/Ellipse.png "Elipse")</p>[API](xref:Xamarin.Forms.Shapes.Ellipse)  /  de [Guía](~/xamarin-forms/user-interface/shapes/ellipse.md) de | <p valign="center"><pre>&lt;Ellipse Fill="Red"<br />         WidthRequest="150"<br />         HeightRequest="50"<br />         HorizontalOptions="Center" /&gt;</pre></p> |
...
| <h3>Map</h3>Muestra un mapa.<p align="center">![Captura de pantalla de un mapa](xaml-controls-images/Map.png "Map")</p>[API](xref:Xamarin.Forms.Maps.Map)  /  de [Guía](~/xamarin-forms/user-interface/map/index.md) de | <p valign="center"><pre>&lt;maps:Map ItemsSource="{Binding Locations}" /&gt;</pre></p> |
