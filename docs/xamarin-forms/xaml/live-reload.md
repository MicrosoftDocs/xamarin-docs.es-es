...
La recarga en vivo funciona con cambios en cualquier archivo XAML. Los cambios C# o la adición o eliminación de paquetes NuGet requieren una nueva compilación e implementación para que surtan efecto.
