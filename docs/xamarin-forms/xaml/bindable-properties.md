...
- Un `Func` que se usa para inicializar un valor de propiedad predeterminado. Para obtener más información, vea [crear un valor predeterminado con una FUNC](#create-a-default-value-with-a-func).
