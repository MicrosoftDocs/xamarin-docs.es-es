...
> [!NOTE]
> Los parámetros se pueden especificar en el `Authorize` atributo para restringir una API a usuarios específicos. Para más información, consulte [Autorización](/aspnet/core/security/authorization/introduction/).
