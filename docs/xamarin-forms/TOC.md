...
##### [Datos en tiempo de diseño](xaml/xaml-previewer/design-time-data.md)
...
#### [Personalización de WebView](app-fundamentals/custom-renderer/hybridwebview.md)
...
#### [Enlaces relativos](app-fundamentals/data-binding/relative-bindings.md)
...
#### [RoundEffect reutilizable](app-fundamentals/effects/reusable-roundeffect.md)
...
#### [Interacción](user-interface/carouselview/interaction.md)
#### [EmptyView](user-interface/carouselview/emptyview.md)
#### [Desplazarse](user-interface/carouselview/scrolling.md)
...
#### [Elección de un diseño](user-interface/layouts/choose-layout.md)
...
### Asignación
#### [Información general](user-interface/map/index.md)
#### [Inicialización y configuración](user-interface/map/setup.md)
#### [Control de mapa](user-interface/map/map.md)
#### [Posición y distancia](user-interface/map/position-distance.md)
#### [Chinchetas](user-interface/map/pins.md)
#### [Polígonos y polilíneas](user-interface/map/polygons.md)
#### [Codificación geográfica](user-interface/map/geocoder.md)
#### [Inicio de la aplicación de mapa nativa](user-interface/map/native-map-app.md)
...
### Android
#### [Información general](platform/android/index.md)
...
#### [Modo de transición de deslizamiento SwipeView](platform/android/swipeview-swipetransitionmode.md)
...
#### [Acciones de contexto de ViewCell](platform/android/viewcell-context-actions.md)
...
### iOS
#### [Información general](platform/ios/index.md)
...
#### [Estilo de presentación de la página modal](platform/ios/page-presentation-style.md)
...
#### [Modo de transición de deslizamiento SwipeView](platform/ios/swipeview-swipetransitionmode.md)
...
### Windows
#### [Información general](platform/windows/index.md)
...
#### [Dirección de arrastre de RefreshView](platform/windows/refreshview-pulldirection.md)
...
### [Vínculo de origen](internals/sourcelink.md)
