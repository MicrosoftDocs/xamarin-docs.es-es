...
### <a name="reachability"></a>Disponibilidad
...
Hay un [ejemplo de Xamarin. iOS](https://github.com/xamarin/monotouch-samples/tree/master/ReachabilitySample) disponible (que se basa en el [código de ejemplo de accesibilidad](https://developer.apple.com/library/ios/#samplecode/Reachability/Introduction/Intro.html) de Apple) para ayudar a detectar la disponibilidad de la red.
...
Hay un [ejemplo de Xamarin. iOS](http://www.servicestack.net/monotouch/remote-info/) en el sitio web de ServiceStack y un fragmento de código en nuestra [documentación de servicios web](~/cross-platform/data-cloud/web-services/index.md).
