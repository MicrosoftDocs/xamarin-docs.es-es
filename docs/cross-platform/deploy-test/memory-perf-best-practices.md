...
Para más información sobre la inicialización diferida, vea [Lazy Initialization (Inicialización diferida)](/dotnet/framework/performance/lazy-initialization).
