...
Para obtener más información sobre el uso de `UIWebView`, consulte las siguientes recetas:
...
`WKWebView` también se pueden usar en las aplicaciones de Xamarin. Mac y, por lo tanto, es posible que quiera considerar su uso si va a crear una aplicación Mac/iOS multiplataforma.
