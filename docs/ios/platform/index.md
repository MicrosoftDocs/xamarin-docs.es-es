...
## <a name="multitasking-for-ipad"></a>[Multitarea para iPad](~/ios/platform/multitasking.md)
...
## <a name="social-framework"></a>[Marco de redes sociales](~/ios/platform/social-framework.md)
