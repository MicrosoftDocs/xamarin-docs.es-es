...
Además de definir completamente el contenido y el diseño de una vista de pila en el diseñador de iOS, puede crearla y quitarla dinámicamente del C# código.
